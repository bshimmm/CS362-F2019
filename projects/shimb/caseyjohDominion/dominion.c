...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        mineEffect(currentPlayer, state, handPos, choice1, choice2);
    ...
    case minion:
        return minionEffect(currentPlayer, state, handPos, choice1, choice2);
    ...
    case ambassador:
        return ambassadorEffect(currentPlayer, state, handPos, choice1, choice2);
